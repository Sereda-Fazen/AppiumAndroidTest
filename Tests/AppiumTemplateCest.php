...
class AppiumTemplateCest extends PHPUnit_Extensions_AppiumTestCase
{
    ...
    public  function testJenkins ()
    {
        ...
        fwrite(STDOUT, __METHOD__ . " - Click Disable Logs - OK\n");
        ...
        fwrite(STDOUT, __METHOD__ . " - Show login - OK\n");
        ...
        $I->byXPath('//android.widget.FrameLayout/android.widget.ImageView')->click();
        fwrite(STDOUT, __METHOD__ . " - Choose green ball - OK\n");
        ...
        fwrite(STDOUT, __METHOD__ . " - Check search - OK\n");
        ...
        fwrite(STDOUT, __METHOD__ . " - Check Cadence Instance - OK\n");
...
/*
        $I->wraper($I->byXPath('//android.widget.Button[@text="Disable Logs"]')->click(), 1 );
        try{
            $I->byXPath('//android.widget.TextView[@text="Add account"]')->click();
        }catch (Exception $e){
            echo "Error step";}
       // $I->wraper(, 2 );
        $I->wraper($I->byXPath('//android.widget.LinearLayout[1]//android.widget.EditText[@text="Jenkins installation URL"]')->value('jenkins.cadencewatch.com'), 3 );


    public function wrapper($action, $step){
        try{
            echo "\n Start step #$step \n";
            $action;
            echo "Success step #$step \n";
        }catch (Exception $e){
